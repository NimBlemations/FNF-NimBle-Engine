...
class Paths
{
	...
	public static var dumpExclusions:Array<String> = [
		...
		'assets/images/fonts/bold.png', // THAT FIXED ITTTTTTT!!!!!!!!
		'assets/images/fonts/default.png' // THAT FIXED ITTTTTTT!!!!!!!!
	];
	...
	// Just getting bitmap, nothing else
	public static function returnBitmap(key:String, ?library:String):BitmapData
	{
		var path = getPath('images/$key.png', IMAGE, library);
		...
		trace('oh no bitmap $key is returning null NOOOO');
		return null;
	}
	...
	inline static public function bitmap(key:String, ?library:String):BitmapData
	{
		var bitmap:BitmapData = returnBitmap(key, library);
		return bitmap;
	}
