...
class FreeplayState extends MusicBeatState
{
	...
	#if PRELOAD_ALL
	var songThread:Future<Sound>; // Made a variable to hopefully be just one thread.
	#end
	...
	override function create()
	{
		...
		Paths.preloadSound('sounds', 'scrollMenu');
	...
	function changeSelection(change:Int = 0)
	{
		...
		#if PRELOAD_ALL
		songThread = new Future(function() // Asynchronos loding.
		{
			var song:Sound = Paths.inst(songs[curSelected].songName);
			return song;
		}, true).onComplete(function(song:Sound) // Lime futures are fucking cool.
		{
