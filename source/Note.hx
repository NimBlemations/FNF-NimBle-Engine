...
class Note extends FlxSprite
{
	...
	public var timePressing:Float = 1;
	...
	public static var defaultSwagWidth(default, null):Float = 160 * 0.7;

	public static var swagWidth:Float = 160 * 0.7;
	public static var PURP_NOTE(default, null):Int = 0;
	public static var GREEN_NOTE(default, null):Int = 2;
	public static var BLUE_NOTE(default, null):Int = 1;
	public static var RED_NOTE(default, null):Int = 3;
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false)
	{
		...
		{
			Paths.preloadGraphic('NOTE_assets', null, true);
			Paths.preloadGraphic('NOTE_assets_hue', null, true); // Because I don't want any lag if a note from another district pops outta nowhere for some reason.
		}
